...
<div class="max-w-6xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            <span class="px-3 py-1 rounded-full text-xs font-semibold bg-purple-500/10 text-purple-400 border border-purple-500/20 font-mono">
                {{ $employee->employee_id }}
            </span>
        </div>
    </div>

    <div class="glass-dark p-6 sm:p-10 rounded-3xl border border-slate-850">
        <form action="{{ route('admin.employees.update', $employee) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="space-y-6">
                ...
                <div class="p-5 rounded-2xl bg-slate-950/40 border border-slate-800/80 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
                    <div class="w-20 h-20 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-600 text-3xl shrink-0 overflow-hidden relative">
                        @if($employee->profile_image)
                            <img src="{{ asset($employee->profile_image) }}" alt="{{ $employee->full_name }}" class="w-full h-full object-cover">
                        @else
                    ...
                    <div class="flex-grow space-y-1.5 text-center sm:text-left">
                        ...
                        @if($employee->profile_image)
                            <p class="text-xxs text-purple-300">A photo is already set. Uploading a new file will replace the existing photo.</p>
                        @endif
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="dob" name="dob" value="{{ old('dob', $employee->dob ? $employee->dob->format('Y-m-d') : '') }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm" required>
            ...
            <div class="border-t border-slate-850 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="email" id="email_id" name="email_id" value="{{ old('email_id', $employee->email_id) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm" placeholder="personal@example.com">
                ...
                <div>
                    ...
                    <textarea id="aadhaar_address" name="aadhaar_address" rows="2" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm leading-relaxed" placeholder="Village / House No, Post Office, Police Station, District" required>{{ old('aadhaar_address', $employee->aadhaar_address) }}</textarea>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="landmark" name="landmark" value="{{ old('landmark', $employee->landmark) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm" placeholder="e.g. Near High School" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="city" name="city" value="{{ old('city', $employee->city) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm" placeholder="City" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="state" name="state" value="{{ old('state', $employee->state ?? 'West Bengal') }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm" placeholder="State" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="pin_code" name="pin_code" value="{{ old('pin_code', $employee->pin_code) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm" placeholder="e.g. 721630" required>
            ...
            <div class="border-t border-slate-850 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="aadhaar_number" name="aadhaar_number" value="{{ old('aadhaar_number', $employee->aadhaar_number) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono" placeholder="12-digit Aadhaar" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="pan_number" name="pan_number" value="{{ old('pan_number', $employee->pan_number) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono uppercase" placeholder="10-character PAN">
                    ...
                    <div>
                        ...
                        <input type="text" id="voter_id_number" name="voter_id_number" value="{{ old('voter_id_number', $employee->voter_id_number) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono" placeholder="Voter ID Number">
                    ...
                    <div>
                        ...
                        <input type="text" id="old_uan_number" name="old_uan_number" value="{{ old('old_uan_number', $employee->old_uan_number ?? 'NA') }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono" placeholder="Universal Account Number" required>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" id="old_esic_number" name="old_esic_number" value="{{ old('old_esic_number', $employee->old_esic_number) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono" placeholder="ESIC Insurance Number">
            ...
            <div class="border-t border-slate-850 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="joining_date" name="joining_date" value="{{ old('joining_date', $employee->joining_date ? $employee->joining_date->format('Y-m-d') : '') }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" id="work_location" name="work_location" value="{{ old('work_location', $employee->work_location) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm" placeholder="e.g. Kolkata Hub" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="salary" name="salary" value="{{ old('salary', $employee->salary) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono" placeholder="e.g. 18000">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="nth_salary" name="nth_salary" value="{{ old('nth_salary', $employee->nth_salary) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono" placeholder="e.g. 15000" required>
            ...
            <div class="border-t border-slate-850 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="bank_name" name="bank_name" value="{{ old('bank_name', $employee->bank_name) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm" placeholder="e.g. State Bank of India" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="ifsc_code" name="ifsc_code" value="{{ old('ifsc_code', $employee->ifsc_code) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono uppercase" placeholder="e.g. SBIN0001234" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="pass_out_year" name="pass_out_year" value="{{ old('pass_out_year', $employee->pass_out_year) }}" class="mt-2 block w-full px-4 py-3 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm font-mono" placeholder="e.g. 2024" required>
            ...
            <div class="border-t border-slate-850 pt-6 space-y-6">
                ...
                <div class="p-5 rounded-2xl bg-slate-950/40 border border-slate-800/80 max-w-2xl space-y-3">
                    ...
                    @if($employee->employee_document)
                        <div class="pt-2">
                            <a href="{{ asset($employee->employee_document) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-slate-900 hover:bg-slate-800 border border-slate-800 text-xs font-semibold text-purple-300 rounded-xl transition-all shadow-sm">
                                <i class="fa-solid fa-download mr-2 text-purple-400"></i> View / Download Current Document
                            </a>
                        </div>
                    @endif
                    
                    <p class="text-xxs text-slate-500 leading-relaxed">Upload a new consolidated file (PDF, ZIP, or doc/docx, max 20MB) to replace the current document.</p>
