...
@section('title', 'Edit Employee - ' . $employee->employee_id)
@section('page_title', 'Edit Employee: ' . $employee->employee_id)
...
<div class="max-w-6xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            <span class="px-3.5 py-1.5 rounded-full text-xs font-bold bg-blue-50 text-blue-700 border border-blue-200 font-mono shadow-2xs">
    ...
    <div class="bg-white p-6 sm:p-10 rounded-3xl border border-slate-200 shadow-sm">
        <form action="{{ route('admin.employees.update', $employee) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                    ...
                    <div class="relative group">
                        <div id="profile_image_preview_container" class="w-24 h-24 rounded-2xl bg-white border-2 border-dashed border-blue-300 shadow-sm flex items-center justify-center text-blue-400 text-3xl shrink-0 overflow-hidden transition-all group-hover:border-blue-500">
                            @if($employee->profile_image)
                                <img id="profile_preview_img" src="{{ asset($employee->profile_image) }}" alt="{{ $employee->full_name }}" class="w-full h-full object-cover">
                                <i class="fa-solid fa-camera text-blue-400/80 hidden" id="profile_placeholder_icon"></i>
                            @else
                    ...
                    <div class="flex-grow space-y-2 text-center sm:text-left">
                        ...
                        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-3">
                            <label for="profile_image" class="inline-flex items-center px-4 py-2 bg-white hover:bg-blue-50 border border-slate-300 hover:border-blue-400 text-slate-700 hover:text-blue-600 rounded-xl text-xs font-semibold shadow-xs cursor-pointer transition-all">
                                <i class="fa-solid fa-cloud-arrow-up mr-2 text-blue-500"></i> Change Photo
                            </label>
                            <span id="profile_file_name" class="text-xs text-slate-500 italic">
                                {{ $employee->profile_image ? 'Current photo is active' : 'No photo uploaded' }}
                            </span>
                        </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-6">
                    ...
                    <div class="sm:col-span-9">
                        ...
                        <input type="text" id="aadhaar_full_name" name="aadhaar_full_name" value="{{ old('aadhaar_full_name', $employee->aadhaar_full_name ?? $employee->full_name) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-medium shadow-xs" placeholder="e.g. John Doe" required>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="dob" name="dob" value="{{ old('dob', $employee->dob ? $employee->dob->format('Y-m-d') : '') }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="mother_tongue" name="mother_tongue" value="{{ old('mother_tongue', $employee->mother_tongue ?? 'Bengali') }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="e.g. Bengali, Hindi" required>
            ...
            <div class="border-t border-slate-100 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="email" id="email_id" name="email_id" value="{{ old('email_id', $employee->email_id) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="personal@example.com">
                    ...
                    <div>
                        ...
                        <input type="text" id="contact_number" name="contact_number" value="{{ old('contact_number', $employee->contact_number) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="Alternate Mobile" required>
                ...
                <div>
                    ...
                    <textarea id="aadhaar_address" name="aadhaar_address" rows="2" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm leading-relaxed shadow-xs" placeholder="Village / House No, Post Office, Police Station, District" required>{{ old('aadhaar_address', $employee->aadhaar_address) }}</textarea>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="landmark" name="landmark" value="{{ old('landmark', $employee->landmark) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="e.g. Near High School" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="city" name="city" value="{{ old('city', $employee->city) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="City" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="state" name="state" value="{{ old('state', $employee->state ?? 'West Bengal') }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="State" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="pin_code" name="pin_code" value="{{ old('pin_code', $employee->pin_code) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="e.g. 721630" required>
            ...
            <div class="border-t border-slate-100 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="aadhaar_number" name="aadhaar_number" value="{{ old('aadhaar_number', $employee->aadhaar_number) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono shadow-xs" placeholder="12-digit Aadhaar" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="pan_number" name="pan_number" value="{{ old('pan_number', $employee->pan_number) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono uppercase shadow-xs" placeholder="10-character PAN">
                    ...
                    <div>
                        ...
                        <input type="text" id="voter_id_number" name="voter_id_number" value="{{ old('voter_id_number', $employee->voter_id_number) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono shadow-xs" placeholder="Voter ID Number">
                    ...
                    <div>
                        ...
                        <input type="text" id="old_uan_number" name="old_uan_number" value="{{ old('old_uan_number', $employee->old_uan_number ?? 'NA') }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono shadow-xs" placeholder="Universal Account Number" required>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" id="old_esic_number" name="old_esic_number" value="{{ old('old_esic_number', $employee->old_esic_number) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono shadow-xs" placeholder="ESIC Insurance Number">
            ...
            <div class="border-t border-slate-100 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="joining_date" name="joining_date" value="{{ old('joining_date', $employee->joining_date ? $employee->joining_date->format('Y-m-d') : '') }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs">
                    ...
                    <div>
                        ...
                        <input type="text" id="work_location" name="work_location" value="{{ old('work_location', $employee->work_location) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="e.g. Kolkata Hub" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="salary" name="salary" value="{{ old('salary', $employee->salary) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono shadow-xs" placeholder="e.g. 18000">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="nth_salary" name="nth_salary" value="{{ old('nth_salary', $employee->nth_salary) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono shadow-xs" placeholder="e.g. 15000" required>
            ...
            <div class="border-t border-slate-100 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="bank_name" name="bank_name" value="{{ old('bank_name', $employee->bank_name) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-xs" placeholder="e.g. State Bank of India" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="ifsc_code" name="ifsc_code" value="{{ old('ifsc_code', $employee->ifsc_code) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono uppercase shadow-xs" placeholder="e.g. SBIN0001234" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="pass_out_year" name="pass_out_year" value="{{ old('pass_out_year', $employee->pass_out_year) }}" class="mt-2 block w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono shadow-xs" placeholder="e.g. 2024" required>
            ...
            <div class="border-t border-slate-100 pt-6 space-y-6">
                ...
                @if($employee->employee_document)
                    ...
                    <div class="p-4 bg-blue-50/60 border border-blue-200 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-3">
                        <div class="flex items-center space-x-3 text-left">
                            <div class="w-10 h-10 rounded-xl bg-blue-600 text-white flex items-center justify-center text-lg shrink-0">
                                <i class="fa-solid fa-file-lines"></i>
                            </div>
                            <div>
                                <span class="text-xs font-bold text-slate-800 block">Current Attached Document</span>
                                <span class="text-xxs text-slate-500 block">{{ basename($employee->employee_document) }}</span>
                            </div>
                        </div>
                        <a href="{{ asset($employee->employee_document) }}" target="_blank" class="px-4 py-2 bg-white hover:bg-blue-600 hover:text-white border border-blue-300 text-blue-700 text-xs font-semibold rounded-xl shadow-2xs transition-all flex items-center shrink-0">
                            <i class="fa-solid fa-download mr-1.5"></i> View / Download
                        </a>
                    </div>
                @endif
                ...
                <div class="relative">
                    <label for="employee_document" 
                        ...
                        <h4 class="text-sm font-bold text-slate-800 group-hover:text-blue-600 transition-colors">
                            {{ $employee->employee_document ? 'Upload new replacement file' : 'Click to upload' }} <span class="font-normal text-slate-500">or drag and drop document</span>
                        </h4>
                ...
                <p class="text-xs text-slate-500 leading-relaxed">
                    <i class="fa-solid fa-circle-info mr-1 text-blue-500"></i> Uploading a new document will replace the currently active attachment.
                </p>
            ...
            <div class="pt-6 border-t border-slate-100 flex items-center justify-end space-x-4">
                ...
                <button type="submit"
                    ...
                    <i class="fa-solid fa-floppy-disk mr-2"></i> Save & Update Employee Record
                </button>
            </div>
        </form>
    </div>
