...
<div class="max-w-5xl mx-auto space-y-6">
    <form action="{{ route('admin.companies.store') }}" method="POST" id="company-form" class="space-y-6">
        @csrf
        ...
        <div class="glass-dark p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xl space-y-6">
            <h3 class="font-outfit font-bold text-xl text-slate-850 flex items-center">
                <i class="fa-solid fa-building text-purple-650 mr-2.5"></i> Company Profile Details
            </h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="1"
                        ...
                        placeholder="Full postal address of the company office...">{{ old('address') }}</textarea>
                    @error('address')
                        <span class="text-xs text-rose-500 mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="border-t border-slate-100 pt-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <label class="relative flex p-4 cursor-pointer rounded-2xl border-2 transition-all duration-200 {{ old('type', 'employee') === 'employee' ? 'border-purple-500 bg-purple-50/40 ring-2 ring-purple-500/20' : 'border-slate-200 hover:border-slate-300 bg-white' }}" id="type_employee_card">
                        <input type="radio" name="type" value="employee" {{ old('type', 'employee') === 'employee' ? 'checked' : '' }} class="sr-only" onchange="updateTypeSelection(this.value)">
                        <div class="flex items-start space-x-3.5">
                            ...
                            <div class="space-y-1">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-[10px] uppercase font-bold px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700">Default</span>
                                </div>
                    ...
                    <label class="relative flex p-4 cursor-pointer rounded-2xl border-2 transition-all duration-200 {{ old('type') === 'staff' ? 'border-purple-500 bg-purple-50/40 ring-2 ring-purple-500/20' : 'border-slate-200 hover:border-slate-300 bg-white' }}" id="type_staff_card">
                        <input type="radio" name="type" value="staff" {{ old('type') === 'staff' ? 'checked' : '' }} class="sr-only" onchange="updateTypeSelection(this.value)">
                        <div class="flex items-start space-x-3.5">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="basic" name="basic" value="{{ old('basic', '0.00') }}"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="hra" name="hra" value="{{ old('hra', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="conveyance" name="conveyance" value="{{ old('conveyance', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="medical_allowance" name="medical_allowance" value="{{ old('medical_allowance', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="sp_allowance" name="sp_allowance" value="{{ old('sp_allowance', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                ...
                <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="bonus" name="bonus" value="{{ old('bonus', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="employer_pf" name="employer_pf" value="{{ old('employer_pf', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="employer_esic" name="employer_esic" value="{{ old('employer_esic', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="employer_lwf" name="employer_lwf" value="{{ old('employer_lwf', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                ...
                <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="employee_pf" name="employee_pf" value="{{ old('employee_pf', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="employee_esic" name="employee_esic" value="{{ old('employee_esic', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="employee_lwf" name="employee_lwf" value="{{ old('employee_lwf', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="professional_tax" name="professional_tax" value="{{ old('professional_tax', '0.00') }}"
                            class="sal-input mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm font-medium focus:ring-1 focus:ring-purple-500">
                    </div>
        ...
        <div class="flex items-center justify-end space-x-3 pt-4">
            ...
            <button type="submit" class="px-6 py-3.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white rounded-xl text-xs font-semibold transition-all shadow-lg shadow-purple-500/10">
                <i class="fa-solid fa-circle-check mr-1.5"></i> Register Company & Save Annexure
            </button>
        </div>
    </form>
</div>
