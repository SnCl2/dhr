...
@section('title', 'Edit Department - RM HR Solutions')
@section('page_title', 'Edit Department Details')
...
<div class="max-w-2xl mx-auto">
    <div class="glass-dark p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xl">
        <h3 class="font-outfit font-bold text-xl text-slate-850 mb-6 flex items-center">
            <i class="fa-solid fa-folder-tree text-purple-650 mr-2.5"></i> Update Department Details
        </h3>
