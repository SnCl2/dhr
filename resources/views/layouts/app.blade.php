            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center space-x-3 group">
                        ...
                        <span class="font-outfit font-extrabold text-2xl tracking-wider bg-gradient-to-r from-purple-800 via-purple-600 to-indigo-500 bg-clip-text text-transparent group-hover:text-purple-600 transition-colors duration-300">ADHIKSHITA</span>
                    </a>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="font-outfit font-extrabold text-xl tracking-wider text-white">ADHIKSHITA PLOTTERS</span>
                    </div>
